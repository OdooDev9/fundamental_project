...
class AccountInvoice(models.Model):
    ...
    from_part_order = fields.Boolean(string="Invoice From Part Order", Default='False')
...
class PartOrder(models.Model):
    ...
    business_id = fields.Many2one('business.unit', string="Business Unit", default=lambda self: self.env.user.current_bu_br_id,domain="[('business_type','=','bu')]")
