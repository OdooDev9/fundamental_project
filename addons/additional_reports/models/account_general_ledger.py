...
class AccountGeneralLedgerReportTrio(models.AbstractModel):
    _name = "account.general.ledger.trio"
    _description = "General Ledger Report By Trio"
    ...
    def _get_templates(self):
        templates = super(AccountGeneralLedgerReportTrio, self)._get_templates()
    ...
    def _get_options_domain(self, options):
        # OVERRIDE
        domain = super(AccountGeneralLedgerReportTrio, self)._get_options_domain(options)
