...
class ReportAccountAgedPartner(models.AbstractModel):
    ...
    def _get_sql(self):
        if self.env.user.user_type_id == 'br' or self.env.user.user_type_id == 'bu' or self.env.user.user_type_id == 'div':
            ...
            bu_br_clause = 'and (move.hr_bu_id IS NULL or move.hr_bu_id IS NOT NULL)'
        ...
        query = ("""
            ...
            JOIN account_move move ON account_move_line.move_id = move.id {bu_br_clause}
